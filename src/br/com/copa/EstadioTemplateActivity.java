...
/*Classe responsável em gerar a view que irá exibir as informações do estádio escolhido pelo usuário*/
...
public class EstadioTemplateActivity extends Activity {
	...
	public void showEstadio(Estadio estadio){
      ...
      // Bitmap bMapScaled = Bitmap.createScaledBitmap(bmp, 500, 250, true); // define o tamanho da imagem (originalBitmap, newX, newY, true) 
       ...
       //imView.setImageBitmap( bMapScaled);
